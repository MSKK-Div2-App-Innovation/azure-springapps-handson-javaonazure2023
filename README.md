...
- **演習 5 Azure Spring Apps の自動スケーリング**
...
- **演習 4**
	1. [監視の設定](./steps/P4-01.md)
	1. [トラフィックの作成](./steps/P4-02.md)
   	1. [アプリの監視](./steps/P4-03.md)　
   	1. [アプリログのリアルタイム監視](./steps/P4-04.md)

    <br>

- **演習 5**
	1. [自動スケーリングの条件を定義](./steps/P5-01.md)
	1. [自動スケーリングを体験](./steps/P5-02.md)
